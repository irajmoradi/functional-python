# Functional Python [![](https://github.com/irajmoradi/functional-python/workflows/tests/badge.svg)](https://github.com/irajmoradi/functional-python/actions?query=workflow%3Atests)
